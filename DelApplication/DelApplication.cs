    ...
    internal class DelApplication
    {
        static void Main(string[] args)
        {
            ...
            if (args.Length < 2)
            {
                ...
                Console.WriteLine("Поддерживаются опциональные ключи от удаляемых программ, если таковы есть (например для тихого удаления без перезагрузки)");
                Console.WriteLine("Так же поддерживается удаление любых папок или файлов, то есть можно удалять \"Portable\" программы.\n");
